    ...
    <div className="min-h-screen bg-white text-black flex">
      ...
      <div className="flex-1 px-10 py-10">
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
          <h2 className="text-4xl font-bold">Ad Generator</h2>
          <p className="text-gray-600 mt-2 text-lg">
            High-converting ad copy with hooks, angles & CTA — built for results.
          </p>
        </motion.div>
        ...
        >
          {/* PLATFORM */}
          <p className="uppercase text-sm text-gray-500 mb-2">Platform</p>
          ...
          {/* OBJECTIVE */}
          <p className="uppercase text-sm text-gray-500 mb-2">Objective</p>
          <div className="flex gap-2 flex-wrap mb-6">
            {OBJECTIVES.map((o) => (
              <button
                key={o}
          ...
          {/* PRODUCT */}
          <label className="uppercase text-sm text-gray-500">Product</label>
          <input
            value={product}
          ...
          {/* AUDIENCE */}
          <label className="uppercase text-sm text-gray-500 mt-6 block">
            Audience
          </label>
          <input
            value={audience}
          ...
          >
            <div className="flex justify-between mb-3">
              <h3 className="font-semibold text-xl">
                Generated Ad <span className="text-amber-600">· {platform}</span>
              </h3>
