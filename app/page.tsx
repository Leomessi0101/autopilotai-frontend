...
export default function HomePage() {
  ...
  return (
    <div className="root">
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300;400;500;600;700&family=Clash+Display:wght@400;500;600;700&family=Playfair+Display:ital,wght@0,400;0,700;1,400;1,700&display=swap');
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .build-wrap:focus-within {
          border-color: rgba(110,231,183,0.4);
          box-shadow: 0 0 0 4px rgba(110,231,183,0.06), 0 0 32px rgba(110,231,183,0.06);
        }
        .build-input {
          width: 100%; border: none; outline: none;
          font-family: var(--body); font-size: 15px; font-weight: 400;
          color: var(--text); padding: 20px 22px 8px;
        ...
        .mockup-frame::before {
          content: '';
          position: absolute; inset: 0; z-index: 0;
          background: linear-gradient(135deg, rgba(110,231,183,0.03) 0%, transparent 50%);
          pointer-events: none;
        }
        .mbar {
          background: #0A0A0D; padding: 12px 16px;
        ...
        .murl {
          ...
          padding: 5px 12px; font-size: 10px; color: var(--text3);
        ...
        .mtabs {
          ...
          padding: 10px 12px; display: flex; gap: 5px; flex-wrap: wrap;
          position: relative; z-index: 1;
        }
        .mtab {
        ...
        .float-chip {
          ...
          box-shadow: 0 8px 32px rgba(0,0,0,0.4); white-space: nowrap; z-index: 10;
        }
        ...
        .step-arrow {
          margin-top: 28px; font-size: 20px; color: var(--accent);
          position: relative; z-index: 1;
        }
        .step-divider {
          display: flex; align-items: center; justify-content: center;
        ...
        .tool-card {
          background: var(--surface);
          padding: 40px 32px 52px; position: relative; overflow: hidden;
        ...
        .tool-card::before {
          ...
          background: radial-gradient(circle at 80% 20%, var(--tc,transparent) 0%, transparent 50%);
        ...
        .tool-cta {
          ...
          font-size: 18px; color: var(--text3); z-index: 1;
        ...
        .proof-earned {
          ...
          margin-bottom: 20px; color: #060608;
        }
        .proof-quote {
        ...
        .proof-av {
          ...
          font-size: 11px; font-weight: 700; color: #060608;
          display: flex; align-items: center; justify-content: center;
          flex-shrink: 0;
        }
        ...
        .price-card-featured {
          ...
          box-shadow: 0 0 0 1px rgba(110,231,183,0.1), 0 0 60px rgba(110,231,183,0.05);
        }
        .price-badge {
        ...
        .price-cta {
          display: block; margin-top: 36px; padding: 14px;
          border-radius: 12px; text-align: center; text-decoration: none;
          font-size: 13px; font-weight: 700; letter-spacing: 0.02em;
          border: 1px solid; transition: all 0.2s; font-family: var(--body); cursor: pointer;
        }
        .price-cta-outline {
          border-color: var(--border2); color: var(--text2); background: transparent;
        }
        ...
        /* ── FINAL CTA ───────────────────────────── */
        .final {
          padding: 140px 40px; background: var(--bg);
        ...
        .final-box:focus-within {
          border-color: rgba(110,231,183,0.4);
          box-shadow: 0 0 32px rgba(110,231,183,0.06);
        }
        .final-input {
          width: 100%; background: transparent; border: none; outline: none;
          font-family: var(--body); font-size: 14px; color: var(--text);
          padding: 16px 18px 8px; letter-spacing: -0.01em;
        }
        ...
        .final-btn {
          ...
          border-radius: 8px; transition: filter 0.2s, transform 0.15s;
          white-space: nowrap;
        }
        ...
        /* ── FOOTER ─────────────────────────────── */
        .footer {
          background: #030304; border-top: 1px solid var(--border);
          padding: 32px 40px;
        }
        .footer-inner {
        ...
        <div className="hero-inner">
          <div>
            ...
            <div className={mounted ? "fu2" : "preinit"}>
              <h1 className="hero-h1">
                Get more clients.<br />
                <em>Not more stress.</em><br />
                <span className="dim">In under a minute.</span>
              </h1>
            </div>
            <div className={mounted ? "fu3" : "preinit"}>
              <p className="hero-sub">
                Tell AutopilotAI about your business. It builds a
                <strong> professional, conversion-ready website</strong> in seconds —
                custom copy, smart design, ready to publish.
                <strong> No code. No designer. $10/mo.</strong>
              </p>
            </div>
          ...
          <div className={`mockup-col ${mounted ? "fu5" : "preinit"}`}>
            ...
            <div className="mockup-frame">
              <div className="mbar">
                <div className="mdots">
                  {["#ff5f57","#febc2e","#28c840"].map((c,i) => <div key={i} className="mdot" style={{ background: c }} />)}
                </div>
                <div className="murl">
                  <span className="murl-lock">🔒</span>
                  <span className="murl-text" key={activeBiz} style={{ animation: "slideIn 0.4s ease both" }}>
                    {biz.domain}.com
                  </span>
                </div>
              </div>
              <div className="mbody">
                {BUSINESSES.map((b, i) => (
                  <div key={i} className="mslide" style={{
                    ...
                    <div className="mcard" style={{ background: `linear-gradient(135deg, ${b.color}14, ${b.color}05)`, borderLeft: `3px solid ${b.color}` }}>
                      ...
                      <div className="mcard-title" style={{ color: "var(--text)" }}>
                        The Most Trusted {b.type} in {b.city} — <em style={{ color: b.color }}>Guaranteed.</em>
                      </div>
                    ...
                    <div className="mfeats">
                      {["✅ Licensed","⭐ 5-Star","⚡ Same Day"].map((f,fi) => (
                        <div key={fi} className="mfeat"><div className="mfeat-text">{f}</div></div>
                      ))}
                    </div>
                  </div>
                ))}
              ...
              <div className="mtabs">
                {BUSINESSES.map((b,i) => (
                  <button key={i} className="mtab" onClick={() => setActiveBiz(i)} style={{
                    borderColor: activeBiz===i ? b.color : "rgba(255,255,255,0.08)",
                    background: activeBiz===i ? `${b.color}18` : "transparent",
                    color: activeBiz===i ? b.color : "var(--text3)"
                  }}>
                    {b.icon} {b.type}
                  </button>
                ))}
      ...
      <div className="ticker">
        <div style={{ overflow: "hidden" }}>
          <div className="ticker-track">
            {["Professional website in 60 seconds","Custom AI-written copy","$10/month to go live","No code required","14-day free trial","SEO-optimized from day one","Mobile perfect always","Cancel anytime",
              "Professional website in 60 seconds","Custom AI-written copy","$10/month to go live","No code required","14-day free trial","SEO-optimized from day one","Mobile perfect always","Cancel anytime"]
              .map((t,i) => (
              <div key={i} className={`ticker-item ${i%3===0?"hi":""}`}>
          ...
          <div className="problem-layout">
            <div>
              ...
              <h2 className="section-h">
                Getting a great site<br />
                <em>shouldn't cost</em><br />
                a fortune.
              </h2>
              <p className="section-body">
                You've wasted hours on drag-and-drop builders that still look amateur.
                Agency quotes start at $5,000 and take 6 weeks. You just need something
                that looks great and actually gets you customers.
                <br /><br />
                AutopilotAI does the whole thing while you have coffee.
              </p>
            </div>
            <div className="prob-cards">
              {[
                { icon:"😩", label:"Squarespace / Wix", desc:"You spend 3 days and still hate the result" },
      ...
      <section className="process">
        <div className="process-inner">
          <div className="process-header">
            ...
            <p className="section-body" style={{ textAlign:"center", maxWidth: 400, margin: "16px auto 0" }}>
              No design experience needed. No waiting around. Just describe your business and go.
            </p>
          </div>
          <div className="steps">
            {[
              ...
              <>
                ...
                {i < arr.length - 1 && (
                  <div key={`div-${i}`} className="step-divider">
                    <span className="step-divider-icon">›</span>
                  </div>
                )}
              </>
            ))}
      ...
      <section className="tools">
        <div className="tools-inner">
          <div className="tools-header">
            ...
            <p className="tools-header-right">
              Once your site is live, keep customers coming.
              Every plan includes AI tools for email, ads, and content — all in one place.
            </p>
          </div>
          <div className="tools-grid">
            {[
              ...
              { icon:"✍️", tag:"Content AI", name:"Content Writer", desc:"Blog posts, product descriptions, social captions. On-brand. Instant. Actually good.", color:"#F472B6", bg:"rgba(244,114,182,0.1)", href:"/dashboard/content" },
            ].map((tool,i) => (
          ...
          <div className="features-layout">
            <div>
              ...
              <p className="section-body" style={{ marginTop: 16 }}>
                One tool. No plugin shopping. No duct tape. Everything to get clients online is already here.
              </p>
            ...
            <div className="metrics">
              {[
                ...
                { val:"100%", label:"Mobile responsive, every time, guaranteed", color:"var(--accent3)" },
      ...
      <section className="pricing">
        <div className="pricing-inner">
          <div className="pricing-header">
            ...
            <p className="section-body" style={{ textAlign:"center", margin:"16px auto 0", maxWidth:400 }}>
              Build and edit everything free. Only pay when you're ready to go live.
            </p>
          </div>
          <div className="pricing-grid">
            <div className="price-card">
              ...
              <div className="price-feats">
                {([
                  ...
                  <div key={i} className={`pf ${y?"pf-on":"pf-off"}`}>
                    <div className={`pfc ${y?"pfc-y":"pfc-n"}`}>{y?"✓":"✕"}</div>
                    {l}
                  </div>
                ))}
              </div>
            ...
            <div className="price-card price-card-featured">
              ...
              <div className="price-amount" style={{ color:"var(--accent)" }}>
                $10<span style={{ fontSize:20, color:"var(--text3)" }}>/mo</span>
              </div>
              <div className="price-sub">14-day free trial — cancel anytime</div>
              <div className="price-feats">
                {["Publish your website","Custom domain included","Unlimited AI generations","20 AI images/month","Analytics dashboard","Priority support"].map((l,i) => (
                  <div key={i} className="pf pf-on">
                    <div className="pfc pfc-y">✓</div>
                    {l}
                  </div>
                ))}
              </div>
      ...
      <section className="faq">
        <div className="faq-inner">
          ...
          {[
            ...
            { q:"Can I edit it after the AI builds it?", a:"Click any text to edit. Swap images. Add sections. Or just type a new prompt and regenerate entirely. No code, no friction, no waiting." },
            { q:"What if I don't like the first result?", a:"Regenerate as many times as you want on the free plan. Try different styles, tones, layouts. You only pay when you're happy with it." },
      ...
      <section className="final">
        ...
        <div className="final-inner">
          <h2 className="final-h">
            Your next client<br />
            is <em>searching</em><br />
            right now.
          </h2>
          <p className="final-sub">
            On Google. Looking for exactly what you offer.
